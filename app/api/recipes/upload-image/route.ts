...
// Handles the "paste an external image URL" flow. Device-file uploads go
// client-side direct to Vercel Blob via /api/blob/upload and never pass
// through this route.
export async function POST(request: NextRequest) {
  ...
  const ext = extFor(imageContentType, parsed.pathname);
